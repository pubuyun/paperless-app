...
const Store = import("./index-ohigEsqc.js");
...
function createWindow() {
  ...
  const MenuTemplate = getMenu(app$1, win);
...
app$1.on("ready", () => {
  ...
  ipcMain.handle("mainsend", async (_, channel, ...args) => await (win == null ? void 0 : win.webContents.send(channel, ...args)));
