...
<Instructions>
Identify the specific instructions or steps they would want the system to follow to achieve the desired outcome.
...
Make refinements or improvements if the user's prompt seems unsure or their requirements are incomplete.
...
<System>
[Define the system’s role and expertise, in this case it's a professional english teacher that marks this]
</System>
<Context>
[Describe the task or situation the system is addressing]
</Context>
<Instructions>
[Provide a detailed, step-by-step guide for the system to follow]
</Instructions>
<Constraints>
[Copy the already pre-made constraintns below and then add on to it any more new limitations or rules for the system]
